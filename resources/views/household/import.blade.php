    ...
    <div class="max-w-3xl mx-auto px-4 py-8 space-y-6">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-150 overflow-hidden">
            ...
            <div class="bg-[#0e1e3a] px-6 py-5 border-b border-gray-900 text-white flex justify-between items-center">
                <div>
                    <h2 class="text-base font-bold">Import Household Member Registry</h2>
            ...
            <form action="{{ route('household.import') }}" method="post" enctype="multipart/form-data" class="p-6 md:p-8 space-y-6">
                @csrf
                ...
                <div class="pt-4 border-t border-gray-100 flex justify-end">
                    <button type="submit"
                        ...
                        <i class="fas fa-file-import mr-2"></i> Import Household Data
                    </button>
                </div>
            </form>
        </div>
        ...
        <div class="bg-blue-50 border border-blue-150 rounded-2xl p-6 space-y-3">
            ...
            <ul class="space-y-2 text-xs text-blue-700 font-medium">
                <li class="flex items-start">
                    ...
                    <span>Columns must align with model properties: UnitNo, userId, firstName, lastName, AdultOrMinor, Relation, Student, Age, FamilySize, CertificationDate, RecertificationDate, Code.</span>
                </li>
                <li class="flex items-start">
                    <i class="fas fa-check-circle mr-2 mt-0.5 text-blue-500 flex-shrink-0"></i>
                    <span>The User ID column must associate with an already registered head-of-household profile.</span>
                </li>
            </ul>
        </div>
    </div>
